...
<head>
  ...
  <title>Dinas Perhubungan | Dashboard</title>
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="dist/img/AdminLTELogo.png" alt="DEP" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/" class="brand-link">
      <img src="https://yuridis.id/wp-content/uploads/2018/06/Logo_Departemen_Perhubungan-1024x710.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">DEPHUB</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Dinas Perhubungan</a>
        </div>
      </div>
      ...
      <!-- Sidebar Menu -->
          ...
          <li class="nav-item">
            <a href="{{ route('admin.main_dashboard') }}" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Users
              </p>
          ...
          <li class="nav-item">
            <a href="{{ route('admin.postingan') }}" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Postingan
              </p>
